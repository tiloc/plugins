...
class Camera
    ...
    private class DefaultCameraDeviceWrapper implements CameraDeviceWrapper {
        ...
        public String toString() {
            return "DefaultCameraDeviceWrapper{" +
    ...
    /**
     * Updates the builder settings with all the available features.
     *
    ...
    public void open(String imageFormatGroup) throws CameraAccessException {
        Log.i(TAG, "open: " + imageFormatGroup);
        ...
        cameraManager.openCamera(
                ...
                new CameraDevice.StateCallback() {
                    ...
                    public void onOpened(@NonNull CameraDevice device) {
                        Log.i(TAG, "onOpened - " + debugCameraDevice(device));
                        ...
                        try {
                            ...
                            Log.w(TAG, "onOpened: error occurred", e);
                            // startPreview can throw at least IllegalArgumentException and IllegalStateException
                    ...
                    public void onClosed(@NonNull CameraDevice camera) {
                        Log.i(TAG, "open | onClosed - " + debugCameraDevice(camera));
                    ...
                    public void onDisconnected(@NonNull CameraDevice cameraDevice) {
                        Log.i(TAG, "open | onDisconnected - " + debugCameraDevice(cameraDevice));
                    ...
                    public void onError(@NonNull CameraDevice cameraDevice, int errorCode) {
                        Log.i(TAG, "open | onError - " + debugCameraDevice(cameraDevice) + ", errorCode: " + errorCode);
    ...
    private String debugCameraDevice(CameraDevice cameraDevice) {
        ...
        CameraCaptureSession.StateCallback callback =
                new CameraCaptureSession.StateCallback() {
                    ...
                    public void onConfigured(@NonNull CameraCaptureSession session) {
                        Log.i(TAG, "CameraCaptureSession onConfigured - cameraDevice: " + cameraDevice + ", captureSessionClosed: " + captureSessionClosed);
    ...
    private Handler getBackGroundHandler() {
        Log.i(TAG, "getBackGroundHandler");

        if (backgroundHandlerThread != null) {
            return backgroundHandler;
        } else {
            Log.w(TAG, "getBackGroundHandler: background thread == null");
            return null;
        }
    }
    ...
    public void startBackgroundThread() {
        ...
        try {
            Log.i(TAG, "startBackgroundThread: starting thread: " + backgroundHandlerThread);
    ...
    public void stopBackgroundThread() {
        ...
        final HandlerThread oldBackgroundHandlerThread = backgroundHandlerThread;

        backgroundHandlerThread = null;
        backgroundHandler = null;

        if (oldBackgroundHandlerThread != null) {
            oldBackgroundHandlerThread.quitSafely();
            try {
                oldBackgroundHandlerThread.join();
            } catch (InterruptedException e) {
                // TODO(tiloc): Why is this considered worth reporting to Flutter?
                dartMessenger.error(flutterResult, "cameraAccess", e.getMessage(), null);
            }
        }
    }
    ...
    public void startPreview() throws CameraAccessException {
        Log.i(TAG, "startPreview - pictureImageReader " + pictureImageReader);
        if (pictureImageReader == null) {
            throw new IllegalStateException("startPreview without a pictureImageReader");
        }
        if (pictureImageReader.getSurface() == null) {
            throw new IllegalStateException("startPreview with pictureImageReader with no surface.");
        }
        ...
        imageStreamChannel.setStreamHandler(
                new EventChannel.StreamHandler() {
                    ...
                    public void onCancel(Object o) {
                        imageStreamReader.setOnImageAvailableListener(null, getBackGroundHandler());
                    }
                });
    }
    ...
    private void closeCaptureSession() {
        Log.i(TAG, "closeCaptureSession - captureSession: " + captureSession);
        if (captureSession != null) {
    ...
    public void close() {
        Log.i(TAG, "close - cameraDevice: " + cameraDevice);
